 ...
 * @author jluis
 */
public class cEvaluacionResolucionConflictos extends javax.swing.JInternalFrame {
     int total;
     int id_evaluacion;
     int codigo;
    /**
     ...
     */
    public cEvaluacionResolucionConflictos(int i,int c) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cEvaluacionResolucionConflictos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cEvaluacionResolucionConflictos(1,2).setVisible(true);
            }
        });
    }
