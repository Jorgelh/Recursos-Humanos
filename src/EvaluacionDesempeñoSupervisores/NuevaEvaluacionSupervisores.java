 ...
 * @author jluis
 */
public class NuevaEvaluacionSupervisores extends javax.swing.JInternalFrame {
     ...
     */
    public NuevaEvaluacionSupervisores() {
        initComponents();
    }
    ...
    private void buscar() {
        ...
        try {
            ClassEvaluacionSupervisores p = BDEvaluacionSupervisores.buscarEmpleado(Integer.parseInt(CODIGO.getText()));
...
/*    private void ValidarExistenciaFaceporAño() {
    ...
    public void crearEvaluacionesSuper(){
        ...
        try {
            ...
            ps.executeUpdate("BEGIN CREAREVALUACIONESSUPER(NID_EMPLEADO=>"+idlistaempleado+",NFECHA=>'"+fecha+"',NEVALUACION=>"+evaluacion+",NDEPTO=>"+dept+",NEVALUA=>"+evalua+"); COMMIT; END;");
            c.close();
            ps.close();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("INGRESO NUEVA EVALUACION SUPERVISORES");
