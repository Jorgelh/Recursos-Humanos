...
import EvaluacionDesempeñoOperativo.TiposEvaluacion;
...
public class dEvaluacionTrabajoEnEquipo extends javax.swing.JInternalFrame {
     ...
     */
    public dEvaluacionTrabajoEnEquipo(int i,int c) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                 ...
                 (UNO4.getText().compareTo("0") != 0 || DOS4.getText().compareTo("0")!= 0 || TRES4.getText().compareTo("0")!= 0 || CUATRO4.getText().compareTo("0")!= 0) )
         {
          try {
            ...
            Clases.EvaluacionSupervisores.InsertarEvaluacionSupervisores.insertarTrabajoEquipo(l);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dEvaluacionTrabajoEnEquipo(1,2).setVisible(true);
            }
        });
    }
