...
import Clases.EvaluacionSupervisores.*;
...
public class fEvaluacionLiderazgo extends javax.swing.JInternalFrame {
     ...
     */
    public fEvaluacionLiderazgo(int i, int c){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Clases.EvaluacionSupervisores.InsertarEvaluacionSupervisores.insertarLiderazgo(l);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fEvaluacionLiderazgo(1,2).setVisible(true);
            }
        });
    }
