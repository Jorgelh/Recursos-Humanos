...
public class InicioEvaluacioSupervisores extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ComponenteImagenes/Print.png"))); // NOI18N
        jButton8.setText("   IMPRESION DE EVALUACIONES");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        ImpresionEvaluaciones ma = new ImpresionEvaluaciones();
        Pane1.add(ma); 
        Dimension desktopSize = Pane1.getSize();
        Dimension FrameSize = ma.getSize();
        ma.setLocation((desktopSize.width - FrameSize.width)/2 , (desktopSize.height - FrameSize.height)/2);
