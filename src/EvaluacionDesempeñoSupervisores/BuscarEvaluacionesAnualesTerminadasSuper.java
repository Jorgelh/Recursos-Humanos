 ...
 * @author jluis
 */
public class BuscarEvaluacionesAnualesTerminadasSuper extends javax.swing.JInternalFrame {
     int id_empleado;
     int noevaluacion;
     int codigo;
     int id;
     ...
     */
    public BuscarEvaluacionesAnualesTerminadasSuper() {
        initComponents();
        selectusuario();
    ...
    private void ImprimeEva(){
        ...
        try {
            JasperReport jasperReport=(JasperReport)JRLoader.loadObjectFromFile("\\\\SRVANATEK\\Bases de Datos\\Sistema\\Recursos Humanos\\EvaluacionAnualSupervisores\\AnualSupervisores.jasper");
    ...
    private void ListarEvaluacionesAnualesTerminados(){
        ArrayList<ClassEvaluacionSupervisores> result1 = BDEvaluacionSupervisores.ListarEvaluacionesAnualesSuper(Codigotxt.getText(),depto);
        Listar(result1);  
    }
     private void Listar(ArrayList<ClassEvaluacionSupervisores> list1) {
             ...
             Evaluaciones.setModel(new javax.swing.table.DefaultTableModel(
                datos,
                new String[]{
                "ID","No. Evaluacion","CODIGO","NOMBRE","PUESTO","DEPARTAMENTO"
             })
             {  
                 @Override
