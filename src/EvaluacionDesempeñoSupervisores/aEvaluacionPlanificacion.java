...
public class aEvaluacionPlanificacion extends javax.swing.JInternalFrame {
     ...
     */
    public aEvaluacionPlanificacion(int i,int c) {
        this.codigo = c;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            (UNO4.getText().compareTo("0") != 0 || DOS4.getText().compareTo("0")!= 0 || TRES4.getText().compareTo("0")!= 0 || CUATRO4.getText().compareTo("0")!= 0) )
        {
            try {
                ...
                Clases.EvaluacionSupervisores.InsertarEvaluacionSupervisores.insertarPlanificacion(l);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new aEvaluacionPlanificacion(1,2).setVisible(true);
            }
        });
    }
